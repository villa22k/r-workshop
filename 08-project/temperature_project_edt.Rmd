...
plot(1:120, as.vector(temp_m_1880s), ylab = "Temperature (F)", xlab ="Months in the 1880's", pch = 19, col = "brown", cex = 0.3, main = " 1890's Monthly Average Temperature")
...
plot(1:528, as.vector(temp_m_first_44), ylab = "Temperature (F)", xlab ="Months", pch = 19, col = "dark red", cex = 0.3, main = "Monthly Average Temperature (1970-2012)")
