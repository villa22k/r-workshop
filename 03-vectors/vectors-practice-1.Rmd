...
```{r}
new.p1y <- p1y
new.p1y[p1x > 50] <- new.p1y[p1x > 50]-25
draw(p1x, new.p1y)
```
...
```{r}
new.p2x <- p2x
new.p2x[p2x > 45 & p2y > 50] <- new.p2x[p2x > 45 & p2y > 50]+15
draw(new.p2x, p2y)
```

Here is way to find the desired offset programatically.

```{r}
# Find median of upper right Calvin
shifted.center <- mean(p2x[p2x > 45 & p2x < 100 & p2y > 50])
# Find median of lower right Calvie
target.center <- mean(p2x[p2x > 45 & p2x < 100 & p2y < 50])
# Calculate amount to shift
amount.to.shift <- target.center - shifted.center

new.p2x <- p2x
new.p2x[p2x > 45 & p2y > 50] <- new.p2x[p2x > 45 & p2y > 50] + amount.to.shift
draw(new.p2x, p2y)
```
...
new.p3x[seq(1, length(new.p3y), 2)] <- new.p3x[seq(1, length(new.p3y), 2)] - 5
new.p3y[seq(1, length(new.p3y), 2)] <- new.p3y[seq(1, length(new.p3y), 2)] - 5
